...
const projectsDetail = [
  ...
  },
  {
    ...
    challenge:
      "Assembling a cohesive broadcast showreel required curating high-impact moments across multiple productions while maintaining consistent color grading, pacing, and audio loudness standards suitable for agency and network review.",
    solution:
      "Delivered a frame-accurate editorial pass with broadcast-safe LUFS mastering, unified visual treatment across clips, and a tight narrative arc designed for rapid stakeholder evaluation and pitch decks.",
    videoUrl: "",
  },
  {
    slug: "aurastream",
