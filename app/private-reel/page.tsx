        ...
        {!isUnlocked ? (
            ...
            <form onSubmit={handleUnlock} className="space-y-4">
              <div>
                <input
                  ...
                  className={`w-full bg-black border ${error ? "border-red-500/50 focus:border-red-500" : "border-white/10 focus:border-gold-primary"} p-4 text-center text-sm text-white outline-none transition-colors tracking-[0.3em] font-mono`}
                />
                {error && (
              ...
              <button
                type="submit"
                className="w-full bg-gold-primary text-black font-bold uppercase tracking-widest py-4 text-xs hover:bg-white transition-colors"
              >
                Authenticate
              </button>
            </form>
          ...
          <div className="w-full max-w-5xl mx-auto animate-fade-in">
            ...
            <div className="w-full aspect-video bg-black border border-white/10 relative group flex items-center justify-center overflow-hidden shadow-[0_0_50px_rgba(212,175,55,0.05)]">
              {/* Optional: Add actual iframe for Vimeo/YouTube here */}
            ...
            <div className="mt-12 text-center">
              <button
                ...
                className="text-[10px] uppercase tracking-widest text-text-gray border-b border-text-gray hover:text-white hover:border-white transition-colors pb-1"
              >
                Lock Vault & Exit
              </button>
            </div>
